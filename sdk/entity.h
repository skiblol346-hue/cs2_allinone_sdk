...
public:
	...
	//SCHEMA_ADD_FIELD(void, m_hStattrakAttachment, "C_CSWeaponBase->m_iNumEmptyAttacks");
	//SCHEMA_ADD_FIELD(void, m_hNametagAttachment, "C_CSWeaponBase->m_iNumEmptyAttacks");
...
public:
	...
	SCHEMA_ADD_FIELD(float, m_flLandingTime, "C_CSPlayerPawnBase->m_flLandingTime");
...
public:
	...
	SCHEMA_ADD_FIELD(uint8_t, m_nEconGlovesChanged, "C_CSPlayerPawnBase->m_nEconGlovesChanged");
	SCHEMA_ADD_FIELD(bool, m_bGunGameImmunity, "C_CSPlayerPawnBase->m_bGunGameImmunity");
	SCHEMA_ADD_FIELD(bool, m_bIsWalking, "C_CSPlayerPawnBase->m_bIsWalking");
	SCHEMA_ADD_FIELD(CBaseHandle, GetController, "C_BasePlayerPawn->m_hController");
...
public:
	...
	SCHEMA_ADD_FIELD(CBaseHandle, m_hPredictedPawn, "CBasePlayerController->m_hPredictedPawn");
};